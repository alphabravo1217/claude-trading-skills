...
| [Exposure Coach]({{ '/en/skills/exposure-coach/' | relative_url }}) | Generate a one-page Market Posture summary with net exposure ceiling, growth-vs-value bias, participation breadth, an... | <span class="badge badge-optional">FMP Optional</span> |
...
| [Signal Postmortem]({{ '/en/skills/signal-postmortem/' | relative_url }}) | Record and analyze post-trade outcomes for signals generated by edge pipeline and other skills | <span class="badge badge-optional">FMP Optional</span> |
